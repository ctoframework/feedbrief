        ...
        let payload = PublishDigestPayload {
            ...
            sources: vec![
                PublishSource {
                    ...
                    summary: Some("This paper discusses the latest advancements in AI infrastructure, focusing on GPU cluster interconnects and multi-agent governance frameworks.".to_string()),
                }
            ],
        };
